...
-- 4. INSERT PRODUCTS
INSERT INTO products (id, name, sku, unit, description, category, is_active, created_at, updated_at) VALUES
('770e8400-e29b-41d4-a716-446655440001', N'Xi Măng Hà Tiên PCB40', 'PROD-CEM-01', N'Tấn', N'Xi măng Portland hỗn hợp PCB40 Hà Tiên chất lượng cao', N'Vật liệu thô', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('770e8400-e29b-41d4-a716-446655440002', N'Thép Cuộn Hòa Phát Φ6', 'PROD-STE-02', N'Tấn', N'Thép cuộn xây dựng Hòa Phát phi 6 tiêu chuẩn', N'Sắt thép', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('770e8400-e29b-41d4-a716-446655440003', N'Cát Xây Dựng Sông Đồng Nai', 'PROD-SND-03', N'Khối', N'Cát vàng hạt lớn chuyên dùng cho bê tông đổ móng', N'Cát đá', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('770e8400-e29b-41d4-a716-446655440004', N'Cát Thạch Anh Lọc Nước', 'PROD-QSD-04', N'kg', N'Cát thạch anh mịn dùng lọc nước tiêu chuẩn công nghiệp', N'Cát đá', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('770e8400-e29b-41d4-a716-446655440005', N'Gạch Ống Đồng Tâm 4 Lỗ', 'PROD-BRK-05', N'Viên', N'Gạch ống đất nung 4 lỗ Đồng Tâm kích thước chuẩn', N'Gạch ngói', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('770e8400-e29b-41d4-a716-446655440006', N'Ngói Lợp Đất Nung Viglacera', 'PROD-TLE-06', N'Hộp', N'Ngói lợp 22 viên/m2 Viglacera màu đỏ tươi', N'Gạch ngói', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('770e8400-e29b-41d4-a716-446655440007', N'Sơn Nước Ngoại Thất Dulux Weathershield', 'PROD-PNT-07', N'Thùng', N'Sơn nước ngoại thất Dulux WeatherShield bóng mờ 15L', N'Sơn phủ', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('770e8400-e29b-41d4-a716-446655440008', N'Bê Tông Tươi Holcim Mác 250', 'PROD-CNC-08', N'Khối', N'Bê tông thương phẩm Holcim Mác 250 độ sụt 10+-2', N'Bê tông', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('770e8400-e29b-41d4-a716-446655440009', N'Đá Mi Sàng Đen 1x2', 'PROD-GRV-09', N'Khối', N'Đá mi sàng đen kích cỡ 1x2 cm dùng cho bê tông nhựa', N'Cát đá', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
('770e8400-e29b-41d4-a716-446655440010', N'Vữa Xây Tô Trộn Sẵn Sika Murar', 'PROD-MTR-10', N'Bao', N'Vữa xây tô khô trộn sẵn cao cấp Sika bao 40kg', N'Vật liệu đóng bao', true, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
ON CONFLICT (id) DO NOTHING;
